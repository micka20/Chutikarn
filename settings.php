...
<div class="main-container">
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu-item-container">
            <div class="menu-item submenu-toggle active">
    ...
    <main class="content">
        ...
        <div class="tab-nav" id="mobileTabs">
            ...
            <div class="tab-nav-item <?= $active_tab === 'pane-notifications' ? 'active' : '' ?>" data-tab="pane-notifications">การแจ้งเตือน</div>
            <div class="tab-nav-item <?= $active_tab === 'pane-backup' ? 'active' : '' ?>" data-tab="pane-backup">สำรองข้อมูล</div>
        </div>
