    ...
    <div class="sidebar">
        <div class="menu-items-container">
            <div class="menu-items-top">
                <!-- เมนูสำหรับพนักงาน - มีเพียง 4 เมนู -->
                <a href="Dashboard2.php" class="menu-item active"><div class="icon-medium">&#127968;</div><span>หน้าแรก</span></a>
