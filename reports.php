...
<body>
    ...
    <div class="main-container">
        <div class="sidebar">
            ...
            <a href="reports.php" class="menu-item active"><div class="icon-medium">&#128200;</div><span>รายงาน</span></a>
                ...
                <section class="report-section print-area">
                    <div class="report-header">
                        ...
                        <div class="report-actions no-print">
                            <a href="export.php?report=stock" class="btn-excel">Export to Excel</a>
            ...
            <div id="received" class="tab-content">
                ...
                <section class="report-section print-area">
                    <div class="report-header">
                        ...
                        <div class="report-actions no-print">
                            <a href="export.php?report=received&start_date=<?php echo $start_date; ?>&end_date=<?php echo $end_date; ?>" class="btn-excel">Export to Excel</a>
                            <button class="btn-print" onclick="window.print()">พิมพ์</button>
                        </div>
                    </div>
                    <table>
            ...
            <div id="outgoing" class="tab-content">
                ...
                <section class="report-section print-area">
                    <div class="report-header">
                        ...
                        <div class="report-actions no-print">
                            <a href="export.php?report=outgoing&start_date=<?php echo $outgoing_start_date; ?>&end_date=<?php echo $outgoing_end_date; ?>" class="btn-excel">Export to Excel</a>
                            <button class="btn-print" onclick="window.print()">พิมพ์</button>
                        </div>
                    </div>
            ...
            <div id="user" class="tab-content">
                 <section class="report-section print-area">
                    <div class="report-header">
                        <h3>รายงานผู้ใช้</h3>
                        <div class="report-actions no-print">
                            <a href="export.php?report=user" class="btn-excel">Export to Excel</a>
                            <button class="btn-print" onclick="window.print()">พิมพ์</button>
                        </div>
                    </div>
                    <table>
            ...
            <div id="type" class="tab-content">
                 <section class="report-section print-area">
                    <div class="report-header">
                        ...
                        <div class="report-actions no-print">
                            <a href="export.php?report=type" class="btn-excel">Export to Excel</a>
                            <button class="btn-print" onclick="window.print()">พิมพ์</button>
                        </div>
                    </div>
                    <table>
